...
public class CompanyMainCtroller {
	...
	public String CC(@PathVariable(name = "page") int page,
	...
	public String CH(@PathVariable(name = "page") int page,
			@PathVariable(name = "registrationId") String registrationId, Model model) {
		Enterprise enterpriseInfo = iEnterpriseService.selectEnterpriseOne(registrationId);
		model.addAttribute("ResumeCount", iresume.ResumeCount(registrationId));// Cheader头部的信息刷新
		model.addAttribute("ResumePassCount", iresume.ResumePassCount(registrationId));// Cheader头部的信息刷新
	...
	public String CNHinsert(@ModelAttribute CompanyHiredInfoDto greeting,
		...
		random += random * 10000;
		greeting.setPostId(ijobInfoService.count() + (Math.round(Math.floor(random))));// 系统安排一个postID
	...
	public String CHISEntLogQuality(@PathVariable(name = "registrationId") String registrationId,
			@PathVariable(name = "postId") String postId, Model model) {
		Enterprise enterpriseInfo = iEnterpriseService.selectEnterpriseOne(registrationId);
		model.addAttribute("ResumeCount", iresume.ResumeCount(registrationId));// Cheader头部的信息刷新
		model.addAttribute("ResumePassCount", iresume.ResumePassCount(registrationId));// Cheader头部的信息刷新
	...
	public String CHISEntLog(@PathVariable(name = "registrationId") String registrationId,
	...
	public String CHISEntLogBypostnames(@PathVariable(name = "registrationId") String registrationId,
	...
	public String CHISEntLogPageTurn(@PathVariable(name = "registrationId") String registrationId,
	...
	public String CHISEntLogPageTurnArrage(@PathVariable(name = "registrationId") String registrationId,
	...
	public String CHISEntLogLikeSearchs(@RequestParam(value = "search_keyword") String postNamesL,
			@PathVariable(name = "registrationId") String registrationId,
			@PathVariable(name = "page") Integer pagesTurn, Model model) {
		Enterprise enterpriseInfo = iEnterpriseService.selectEnterpriseOne(registrationId);
		model.addAttribute("ResumeCount", iresume.ResumeCount(registrationId));// Cheader头部的信息刷新
		model.addAttribute("ResumePassCount", iresume.ResumePassCount(registrationId));// Cheader头部的信息刷新
		model.addAttribute("enterprises", enterpriseInfo);// Cheader头部的信息刷新
	...
	public String CHISEntLogLikeSearchPageN(@PathVariable(name = "postNamesL") String postNamesL,
			@PathVariable(name = "registrationId") String registrationId,
			@PathVariable(name = "page") Integer pagesTurn, Model model) {
		Enterprise enterpriseInfo = iEnterpriseService.selectEnterpriseOne(registrationId);
		model.addAttribute("ResumeCount", iresume.ResumeCount(registrationId));// Cheader头部的信息刷新
	...
	public String CHISEntLogLikeSearchPageTurns(@PathVariable(name = "postNamesL") String postNamesL,
			@PathVariable(name = "registrationId") String registrationId,
			@RequestParam(value = "pagesTurn") Integer pagesTurn, Model model) {
		Enterprise enterpriseInfo = iEnterpriseService.selectEnterpriseOne(registrationId);
		model.addAttribute("ResumeCount", iresume.ResumeCount(registrationId));// Cheader头部的信息刷新
	...
	public String resume(@PathVariable(name = "registrationId") String registrationId, Model model,
